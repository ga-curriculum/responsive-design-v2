...
In addition to shrinking/expanding your browser window's width to test its responsive layout, it's considered a good practice to view your app on various other devices.  Each browser/device has various idiosyncrasies, so in a production environment it will become important to see how they handle your app. 
...
- What are some areas to focus on when testing the responsiveness of you app?